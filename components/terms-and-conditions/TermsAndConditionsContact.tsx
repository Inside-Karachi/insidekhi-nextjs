...
export function TermsAndConditionsContact() {
  const contactMethods = [
    {
      icon: Mail,
      title: "Legal Support",
      description:
        "Contact our legal team for questions about terms, conditions, or legal matters",
      contact: "legal@insidekarachi.com",
      action: "mailto:legal@insidekarachi.com",
    ...
    {
      icon: MessageSquare,
      title: "Terms Inquiry Form",
      description:
        "Submit inquiries about our terms and conditions through our contact form",
      contact: "Terms Inquiry Form",
      action: "/contact?subject=terms",
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
              Questions About Our{" "}
              <span className="gradient-text-primary">Terms</span>
            </h2>

            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              If you have questions about these Terms & Conditions, need
              clarification on any provision, or require legal assistance,
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="max-w-4xl mx-auto p-8 rounded-2xl bg-background/95 border border-border/50">
              ...
              <p className="text-muted-foreground mb-6">
                Our legal support team is available Monday through Friday, 9 AM
                to 6 PM PST. For urgent legal matters, we typically respond
                within 24 hours and provide comprehensive assistance for all
                contractual and compliance inquiries.
              </p>
          ...
          <motion.div variants={itemVariants} className="text-center mt-16">
            <p className="text-sm text-muted-foreground">
              These Terms & Conditions were last updated on September 11, 2025.
              We regularly review and update our terms to ensure compliance with
              evolving legal requirements and to protect the interests of both
