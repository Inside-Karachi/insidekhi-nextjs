...
export function TermsAndConditionsHero() {
  ...
  const floatingElements = [
    ...
    { icon: Scale, delay: 3, position: "top-32 right-4 sm:right-32" },
  ];
      ...
      >
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight">
            Terms & <span className="gradient-text-primary">Conditions</span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            These Terms & Conditions govern your use of Inside Karachi&apos;s
          ...
          {[
            {
              ...
              title: "Fair Usage",
              description:
                "Clear guidelines for responsible platform usage and user conduct",
            },
            {
              icon: Scale,
              title: "Legal Compliance",
              description:
                "Terms designed to protect both users and the platform",
            },
            {
              icon: CheckCircle,
              title: "Transparency",
              description: "Clear rights and responsibilities for all parties",
            },
