 ...
 * nested listing_images. Mirrors /api/mobile/v1/favorites/list but returns
 * raw listings_with_details rows (matching the FavoriteListing type) instead
 * of mapped ListingCards, for use by the web favoritesStore.
 */
