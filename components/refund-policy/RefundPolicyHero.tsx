...
export function RefundPolicyHero() {
  ...
  const floatingElements = [
    { icon: RefreshCw, delay: 0, position: "top-20 left-4 sm:left-20" },
    { icon: Shield, delay: 3, position: "top-32 right-4 sm:right-32" },
  ];
        ...
        <>
          {floatingElements.map((element, index) => (
            <motion.div
              ...
              className={cn(
                "absolute p-2 sm:p-3 rounded-lg sm:rounded-xl bg-background/20 backdrop-blur-xl border border-primary/10",
                element.position,
              )}
            >
      ...
      >
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight">
            Refund <span className="gradient-text-primary">Policy</span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Transparent refund policies for all services and purchases made
            through Inside Karachi. We strive to provide fair and clear refund
            processes for our digital services and event tickets.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description:
                "Refunds processed within 7-14 business days when approved",
            },
            {
              icon: CheckCircle,
              title: "Clear Policies",
              description: "Transparent refund conditions for all our services",
            },
            {
              icon: Users,
              title: "Customer Support",
              description:
                "Dedicated support team to assist with refund requests",
            },
